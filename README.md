...
# 或指定版本
curl -fsSL https://raw.githubusercontent.com/gnh1996/simple-connect/main/scripts/install.sh | sh -- --release v0.1.1
...
powershell -ExecutionPolicy Bypass -File "$env:TEMP\simple-connect-install.ps1" -Release v0.1.1
# 若你使用 PowerShell 7，最后一行可换为：
# pwsh -ExecutionPolicy Bypass -File "$env:TEMP\simple-connect-install.ps1" -Release v0.1.1
```
...
Invoke-WebRequest -Uri https://github.com/gnh1996/simple-connect/releases/download/v0.1.1/simple-connect-windows-amd64.exe `
...
# 将输出与 https://github.com/gnh1996/simple-connect/releases/download/v0.1.1/SHA256SUMS 比对
```
...
./scripts/install.sh --release v0.1.1
...
powershell -ExecutionPolicy Bypass -File scripts\install.ps1 -Release v0.1.1    # 指定版本
